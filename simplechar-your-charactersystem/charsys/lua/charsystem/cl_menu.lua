...
-- open_menu is called if menu should be opened
function CharSystem.OpenCharMenu(MaxChars)
	-- [Basic Layout]
	...
	if CharPlaying ~= 1 and CharName1 then
		...
		Char1DeleteButton:SetPos(Char1Panel:GetWide() - 16, 0) -- 16 nicht �ndern
		Char1DeleteButton:SetSize(16, 16) -- 16 is fest nicht �ndern
	...
	if CharPlaying ~= 2 and CharName2 then
		...
		Char2DeleteButton:SetPos(Char2Panel:GetWide() - 16, 0) -- 16 nicht �ndern
		Char2DeleteButton:SetSize(16, 16) -- 16 is fest nicht �ndern
	...
	if CharPlaying ~= 3 and CharName3 then
		...
		Char3DeleteButton:SetPos(Char3Panel:GetWide() - 16, 0) -- 16 nicht �ndern
		Char3DeleteButton:SetSize(16, 16) -- 16 is fest nicht �ndern
